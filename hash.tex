...
\subsection{Inserção, pesquisa e remoção de elementos de tabela de dispersão com encadeamento separado}
...
-- tabela armazenada além do valor a lista de chaves com mesmo índice.
