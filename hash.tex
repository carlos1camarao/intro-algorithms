...
-- Insere (chave,val) na tabela de dispersão. Chaves podem ter o mesmo
-- índice (valor inteiro usado para dispersão), portanto a tabela armazena a
-- lista de chaves que têm o mesmo índice.
