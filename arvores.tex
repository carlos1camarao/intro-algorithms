...
No entanto, vamos considerar apenas (o que é chamado de) {\em árvore
  com raiz\/} (em inglês, {\em rooted tree\/}, e ver essa estrutura de
dados como sendo recursiva, definida de modo a ser ou i) vazia (uma
