...
\index{árvore binária de pesquisa}
...
\begin{enumerate}
  ...
  \item \label{complexidade-da-pesquisa-binaria-no-pior-caso}
    \index{complexidade!de pesquisa binária} A
...
\index{inserção!em árvore binária de pesquisa}
...
\index{complexidade!de inserção em árvore de pesquisa}
...
\index{remoção!de árvore binária de pesquisa}
...
\index{complexidade!de remoção em árvore de pesquisa}
...
\index{pesquisa!em árvore binária de pesquisa!imperativa}
...
Há muitos trabalhos relacionados a algoritmos de pesquisa que envolvem
o balanceamento de árvores binárias de pesquisa, para manter a
...
\index{árvore!bicolor}
\index{árvore!{\em read-black\/}}
\index{árvore!B}
