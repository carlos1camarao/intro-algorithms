...
\item \label{remocao-de-elemento-em-arvore-binaria-de-pesquisa} Defina
  um programa para remoção de um elemento em uma árvore binária de
  pesquisa que use comandos de repetição em vez de funções definidas
  recursivamente.
