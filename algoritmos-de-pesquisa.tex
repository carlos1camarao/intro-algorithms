...
\item \label{ex:alg-ins-arv-AVL} Escreva um programa para percorrer e
  imprimir árvores resultantes de inserções repetidas de elementos em
  uma árvore vazia, usando versão imperativa e/ou funcional do
  algoritmo de inserção em árvore AVL.

\item \label{ex:alg-rem-arv-AVL} Escreva um programa para
