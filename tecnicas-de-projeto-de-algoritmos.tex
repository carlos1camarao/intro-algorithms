...
q\inh{k}, \inh{v} para os quais \inh{p k v} satisfazem ao predicado
(i.e.~\inh{p k v} retorna \inh{True}). No caso, queremos selecionar
apenas os pares \inh{(a,b)}, para algum \inh{b}, que estão no domínio
de \inh{m}.
