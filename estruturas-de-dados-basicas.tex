...
\progb{\struct\ \ListaDeInteiros\ *$p$ = \malloc(\sizeof(\struct\ \ListaDeInteiros))\\
      $p$->\eelem\ = 1;           \hspace*{2.5cm}  $p$->$r$ = \malloc(\sizeof(\struct\ \ListaDeInteiros))\\
      $p$->$r$->\eelem\ = 2;      \hspace*{1.5cm} $p$->$r$->$r$ = \malloc(\sizeof(\struct\ \ListaDeInteiros))\\
      $p$->$r$->$r$->\eelem\ = 3; \hspace*{.5cm} $p$->$r$->$r$->$r$ = \NULL
     }
