...
e usa outras funções também definidas no \Prelude, como \inh{mmap} e
...
\begin{center}
\begin{tabular}{l}
\begin{hask}{foldr,mmap,and,or,any,all,elem}{\decremento}
...
\begin{center}
\begin{tabular}{l}
\begin{alg}{vazia,empilhar,desempilhar,topo,estaVazia}{Cyan}
...
\begin{center}
\begin{tabular}{l}
\begin{hask}{fila,vazia,entrar,sair,estaVazia,primeiro}{Cyan}
vazia = ([],[])
...
\begin{center}
\begin{tabular}{l}
\begin{alg}{fila,vazia,entrar,sair,estaVazia,primeiro}{Cyan}
