...
e o elemento é inserido na sub-árvore \verb+ee+, aumentando a altura
de \verb+ee+.
...
Aa segunda, mostrada no caso \verb+sobED+ abaixo, temos
$\text{\altura\ (\verb+ved+) = \altura\ (\verb+d+)}$ antes da inserção
e o elemento é inserido na sub-árvore com raiz \verb+ved+. 
